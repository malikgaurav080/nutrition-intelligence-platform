...
* Sedentary: 0.8 g per kilogram of body weight
* Normal Active: 1.0 g per kilogram of body weight
* Gym/Muscle Gain: 1.4–2.0 g per kilogram of body weight
* Weight Loss: 1.2–1.8 g per kilogram of body weight
* Older Adults (>65): 1.0–1.2 g per kilogram of body weight
...
Vitamin B5 (Pantothenic Acid)	mg	1–3	2	2	-	-	Age
		4–8	3	3	-	-	Age
		9–13	4	4	-	-	Age
		14+	5	5	6	7	Age
...
290µg
B12
2.8µg  Step 9: Micronutrient Completion %
...
Completion %
        │
        ▼
Health Scores  Practical implementation
For most users, you only need these inputs to generate personalized targets:
* Required: Age, sex, weight, height, activity level.
* Conditional: Pregnancy and breastfeeding (if applicable).
* Goals: Weight loss, maintenance, or muscle gain (mainly affects calories and protein).
