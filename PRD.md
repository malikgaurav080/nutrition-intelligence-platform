...
- **Micro-animations** — rings animate on load, bars fill smoothly
- **Typography** — Inter (headings), Outfit (body)

### Color Palette

| Token | Color | Use |
|---|---|---|
| --primary | #6C63FF | CTAs, highlights |
| --accent | #00D4AA | Success, progress fill |
| --warning | #FFB347 | Mid-range scores |
| --danger | #FF6B6B | Low scores, alerts |
| --bg-dark | #0D0F14 | Main background |
| --bg-card | #161A24 | Card backgrounds |
| --bg-glass | rgba(255,255,255,0.06) | Glass surfaces |
| --text-primary | #FFFFFF | Headings |
| --text-secondary | #8B92A5 | Labels, subtext |

### Health Score Color Guide

| Score | Color | Label |
|---|---|---|
| 80–100% | #00D4AA (Teal) | Excellent |
| 60–79% | #6C63FF (Indigo) | Good |
| 40–59% | #FFB347 (Amber) | Fair |
| 0–39% | #FF6B6B (Red) | Needs Attention |
